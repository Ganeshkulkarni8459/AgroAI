...
//   DateTime? selectedDate;
//   TimeOfDay? selectedTime;
//   String? selectedRegion = 'Pune'; // Default region set to Pune
//   String diseaseName = '';
...
//   void initState() {
//     super.initState();
//     // Fetch agronomists for the default region on initialization
//     fetchAgronomists(selectedRegion!);
//   }
...
//           title: Text('Consultation Scheduled'),
//           content: Text(
//               'You have successfully scheduled a consultation with ${agronomist.name} for $diseaseName on ${selectedDate?.toLocal()} at ${selectedTime?.format(context)}.'),
//           actions: [
//             TextButton(
//               onPressed: () => Navigator.of(context).pop(),
//               child: Text('OK'),
